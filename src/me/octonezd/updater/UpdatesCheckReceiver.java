...
public class UpdatesCheckReceiver extends BroadcastReceiver {
    ...
    public void onReceive(final Context context, Intent intent) {
        ...
        final File s3xml = Utils.getCachedUpdateList(context);
        final File s3xmlNew = new File(s3xml.getAbsolutePath() + UUID.randomUUID());
        ...
        DownloadClient.DownloadCallback callback = new DownloadClient.DownloadCallback() {
            ...
            public void onSuccess() {
                try {
                    if (s3xml.exists() && Utils.checkForNewUpdates(s3xml, s3xmlNew)) {
