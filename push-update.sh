...
updates_dir=/data/s3updater_updates
...
adb shell "killall me.octonezd.updater 2>/dev/null"
adb shell "sqlite3 /data/data/me.octonezd.updater/databases/updates.db" \
